    ...
    public sealed partial class SerialConnectDisconnectPage : Page
    {
        ...
        private async void OnDeviceAdded(DeviceWatcher sender, DeviceInformation deviceInformation)
        {
            await rootPage.Dispatcher.RunAsync(
                ...
                new DispatchedHandler(() =>
                {
                    rootPage.NotifyUser("Device added - " + deviceInformation.Name, NotifyType.StatusMessage);
            ...
            await rootPage.Dispatcher.RunAsync(
                ...
                new DispatchedHandler(() =>
                {
                    ...
                    else if (EventHandlerForDevice.Current.IsEnabledAutoReconnect && EventHandlerForDevice.Current.DeviceInformation != null)
                    {
                        ...
                        rootPage.NotifyUser("Waiting to reconnect to device -  " + EventHandlerForDevice.Current.DeviceInformation.Name, NotifyType.StatusMessage);
                    }
                    else
                    {
